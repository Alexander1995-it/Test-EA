...
const BorderLabelTime = (props) => {
    let width = props.width < 768 ? '70' : '132'
    return (
        <svg width={width} height="54" viewBox="0 0 132 54" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
export default BorderLabelTime;